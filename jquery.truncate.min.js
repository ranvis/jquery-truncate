...
2);e=Math.floor(e/2);g=c.slice(0,k(g,c,0,c.length,f,b.token,!1,{}));e=c.slice(-1*k(e,c,0,c.length,f,"",!0,{}));if(d.whiteSpace.slice(0,3)!=="pre")for(;e.charAt(0)===" ";)e=e.slice(1);d=g+b.token+e}else d=c.slice(0,k(e,c,0,c.length,f,b.token,!1,{}))+b.token;b.addclass&&a.addClass(b.addclass);b.addtitle&&a.attr("title",c);a.text(d)}f.remove()})}})(jQuery);
